...
var DEFAULT_E2E_TEST_ANDROID_OPTS = {
  emu: true,
  avd: "NEXUS_S_18_ARM"
};
...
var boilerplate = function (gulp, opts) {
  ...
  if(opts.e2eTest.android) {
    _.defaults(opts.e2eTest.android, DEFAULT_E2E_TEST_ANDROID_OPTS);
  }
    ...
    gulp.task('coverage', function () {
      return exec('rm -rf ./build').then(function () {
        return globby(covTestFiles).then(function (files) {
          ...
          var args = ['cover', bins._mocha, '--', '--require', __dirname + '/../babelhook', '--compilers', 'babel:babel/register' , '--reporter', 'dot']
            .concat(files);

...
const boilerplate = function (gulp, opts) {
  ...
  if (opts.eslint || opts.tslint || opts.lint) {
  ...
  if (opts.watch) {
    if (opts.eslintOnWatch) {
      console.log(`The 'eslintOnWatch' option is deprecated. Use 'lintOnWatch' instead`); // eslint-disable-line no-console
    }
    const watchSequence = (opts.eslintOnWatch || opts.lintOnWatch) ?
      defaultSequence :
